...
- [RocketMQ为什么性能不如Kafka？](04-mq/rocketmq/RocketMQ为什么性能不如Kafka？.md)
- [RocketMQ与Kafka有什么区别？](04-mq/rocketmq/RocketMQ与Kafka有什么区别？.md)
...
本页是 `rocketmq` 相关知识的目录入口。复习时要把目录中的零散问题串成一条后端链路：请求如何进入系统、如何被转发/处理、如何保证可靠性、性能和安全。
