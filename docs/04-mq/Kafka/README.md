...
- [Kafka百万消息挤压如何处理？](04-mq/Kafka/Kafka百万消息挤压如何处理？.md)
- [Kafka的Exactly-Once语义怎么保证？](04-mq/Kafka/Kafka的Exactly-Once语义怎么保证？.md)
- [Kafka会丢消息吗？](04-mq/Kafka/Kafka会丢消息吗？.md)
- [Kafka入门概要](04-mq/Kafka/Kafka入门概要.md)
...
本页是 `Kafka` 相关知识的目录入口。复习时要把目录中的零散问题串成一条后端链路：请求如何进入系统、如何被转发/处理、如何保证可靠性、性能和安全。
